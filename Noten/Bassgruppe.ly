...
\include "../Noten/OHilfChristeSchuetz_Noten.ly"
...
\header {
  ...
  archivnummer = \archivNummerOHilfChristeSchuetz
  qrcode = \bassgruppeQROHilfChristeSchuetz
  beistrichkomponist = \beistrichKomponistOHilfChristeSchuetz
  beistrichuntertitel = \beistrichUntertitelOHilfChristeSchuetz
  copyright = \copyrightOHilfChristeSchuetz
}
...
\book {
  ...
  \new Staff <<
    \new Voice { 
      \optionalTranspose { \transpose c c \ablaufzeileOHilfChristeSchuetz }
    }
    \new Voice = "vBassgruppe" {
      ...
      \clef "bass"
      \optionalTranspose { \transpose c c \continuoNotenOHilfChristeSchuetz }
    }
